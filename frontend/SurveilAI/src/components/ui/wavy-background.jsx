...
import Navbar from "./navbar-menu"; // Adjust the import path
...
const ExampleUsage = () => {
  return (
    <WavyBackground
      ...
      waveOpacity={0.5}
    >
      <h1 className="text-4xl font-bold text-white">Hello, Wavy Background!</h1>
    </WavyBackground>
  );
};

// Export the ExampleUsage Component
